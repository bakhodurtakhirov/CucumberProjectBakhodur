...
public class _06_WriteIntoDifferentRow {
    public static void main(String[] args) throws IOException {
        ...
        Row row = sheet.createRow(sheet.getPhysicalNumberOfRows()); //Create a row after the last row by using count of rows as index of new row
